...
<head>
    <meta charset="UTF-8">
    <title>Flight Matches | Cabshare</title>
...
<!-- Stylesheet
    ================================================== -->
    <link rel="stylesheet" type="text/css"  href="css/ftable.css">
					...
					<table>
						<thead>
					      ...
					      <?php 
					        ...
					        $q1 = "SELECT * FROM FlightInfo WHERE username = '$me' ORDER BY tdate ";
					        $r1 = $link->query($q1);
					      ?>	
						  <?php  
					    	// PRINTING USER BOOKINGS
					      	$sql2 = "SELECT * FROM FlightInfo WHERE username = '$me' ORDER BY tdate ";
        					...
        					if ($result2->num_rows > 0) 
        					{
          						...
          						{ ?>
    					        	<tr class="table101-row">
    						          ...
    						          <td class="column3"> <?php echo $row2["fno"] ; ?> </td>
 			  	...
 			  	if($r1->num_rows > 0) 
        		{
      				...
      				<table>
						<thead>
      					...
      					<tbody>  
					      <?php 
					        $sql = "SELECT * FROM FlightInfo WHERE username != '$me' AND fno = '$given_fno' AND tdate = '$given_date'";
							  ...
							  <?php
          						...
          						{ ?>
    					        	<tr>
    						          ...
    						          <td class="column3"> <?php echo $row["fno"] ; ?> </td>
